...
public class CaptchaController {
    ...
    public PublicResponse<JSONObject> getCode(HttpServletResponse response) throws IOException
    {
        ...
        bucket.set(code, CAPTCHA_EXPIRATION, TimeUnit.MINUTES);
        // 转换流信息写出
        ...
        {
            return PublicResponse.error("验证码生成失败", null);
        }

        ajax.put("uuid", uuid);
        ajax.put("img", Base64.encode(os.toByteArray()));
        return PublicResponse.success(ajax);
    }
}
